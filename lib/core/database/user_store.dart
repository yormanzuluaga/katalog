...
class UserStore {
  ...
  Future<void> init() async {
    ...
    _userName = _sharedPreferences.getString(PreferencesHelperUser.userName) ?? '';
    _firstName = _sharedPreferences.getString(PreferencesHelperUser.firstName) ?? '';
    _lastName = _sharedPreferences.getString(PreferencesHelperUser.lastName) ?? "";
    _email = _sharedPreferences.getString(PreferencesHelperUser.email) ?? "";
    _accessStore = _sharedPreferences.getString(PreferencesHelperUser.accessStore) ?? "";

    _country = _sharedPreferences.getString(PreferencesHelperUser.country) ?? "";
    ...
    _collaborator = _sharedPreferences.getString(PreferencesHelperUser.collaborator) ?? "";
    _createdAt = _sharedPreferences.getString(PreferencesHelperUser.createdAt) ?? '';
    _updatedAt = _sharedPreferences.getString(PreferencesHelperUser.updatedAt) ?? '';
  ...
  Future<void> logInSession({
    ...
    _userName = userName;
    await _sharedPreferences.setString(PreferencesHelperUser.userName, userName);
    await _sharedPreferences.remove(PreferencesHelperUser.firstName);
    _firstName = firstName;
    await _sharedPreferences.setString(PreferencesHelperUser.firstName, firstName);
    await _sharedPreferences.remove(PreferencesHelperUser.lastName);
    _lastName = lastName;
    await _sharedPreferences.setString(PreferencesHelperUser.lastName, lastName);
    ...
    await _sharedPreferences.setString(PreferencesHelperUser.accessStore, accessStore);
    ...
    await _sharedPreferences.setString(PreferencesHelperUser.collaborator, collaborator);
    ...
    await _sharedPreferences.setString(PreferencesHelperUser.createdAt, createdAt);
    await _sharedPreferences.remove(PreferencesHelperUser.updatedAt);
    _updatedAt = updatedAt;
    await _sharedPreferences.setString(PreferencesHelperUser.updatedAt, updatedAt);
  }
