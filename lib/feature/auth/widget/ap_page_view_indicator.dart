...
class APPageViewIndicator extends StatefulWidget {
  ...
  @override
  State<APPageViewIndicator> createState() => _APPageViewIndicatorState();
}

class _APPageViewIndicatorState extends State<APPageViewIndicator> {
