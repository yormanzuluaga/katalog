...
class AppPageViewIndicator extends StatefulWidget {
  ...
  @override
  State<AppPageViewIndicator> createState() => _AppPageViewIndicatorState();
}

class _AppPageViewIndicatorState extends State<AppPageViewIndicator> {
